...
function CopyRoomButton() {
  ...
  return (
    <a aria-label="Copy Room URL" className="flex justify-center items-center w-40 relative px-5 py-1 overflow-hidden border border-black rounded group" onClick={copyUrlToClipboard}>
